      ...
      <div className="px-6 py-2">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center justify-between">
            {/* Left: Main + Data Filters (text with chevrons) */}
            ...
            <div className="flex items-center gap-1 px-2 py-1 rounded-md border border-gray-300 bg-white text-xs text-gray-700">
